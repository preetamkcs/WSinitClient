 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://example/", wsdlLocation = "http://localhost:8280/WSInit/service?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8280/WSInit/service?wsdl");
